...
| _(none)_ | TotpGenerate | Generates TOTP codes server-side (implies Totp) |

`Totp` and `TotpGenerate` are not currently assigned display codes and do not appear in the CAPS column.
