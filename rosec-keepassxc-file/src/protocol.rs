...
//!
//! Some types in this verbatim copy are not used by every guest (e.g.
//! ssh-key types, notification types).  We allow `dead_code` at module
//! level rather than diverging from the host's definitions.
